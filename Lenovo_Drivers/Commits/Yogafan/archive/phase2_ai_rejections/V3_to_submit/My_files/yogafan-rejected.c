...
struct yogafan_config {
	...
	u32 fan_count;			/* 1 to MAX_FANS */
	u32 n_max;			/* Discrete steps (0 = Continuous) */
	u32 r_max;			/* Max physical RPM for estimation */
	u32 tau_ms;			/* To store the smoothing speed    */
	u32 slew_time_s;		/* To store the acceleration limit */
	u32 stop_threshold;		/* To store the RPM floor */
...
/* ThinkBook 14 G7+ (21Q4) - 85mm High-Density Fan */
static const struct yogafan_config thinkbook_g7_cfg = {
	.multiplier = 100, .fan_count = 1, .n_max = 0,
	.r_max = 5500, .tau_ms = 1000, .slew_rpm_s = 4, .stop_threshold = 50,
	.paths = { "\\_SB.PCI0.LPC0.EC0.FA1S" }
};
...
static const struct yogafan_config thinkpad_discrete_cfg = {
	.multiplier = 0, .fan_count = 1, .n_max = 7, .r_max = 5500,
	.tau_ms = 1000, .slew_time_s = 4, .stop_threshold = 50,
	.paths = { "\\_SB.PCI0.LPC0.EC0.FAN0", "\\_SB.PCI0.LPC0.EC0.FANS" }
};
			 ...
			 u32 attr, int channel, long *val)
{
	...
	/* 2. Polling Protection */
        dt_ms = ktime_ms_delta(ktime_get_boottime(), data->last_sample[channel])
	if (data->last_sample[channel] != 0 && dt_ms < MIN_SAMPLING) {
		*val = data->filtered_val[channel];
		return 0;
	}

	/* 3. Hardware Reading: Retrieve raw RPM from EC */
	status = acpi_evaluate_integer(data->active_handles[channel], NULL, NULL, &raw_acpi);

	/* If the first attempt fails, return I/O error  */
...
static const struct dmi_system_id yogafan_quirks[] = {
	...
	{
		.ident = "Lenovo Yoga Slim 7i 9 (83CV)",
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),
	...
	{
		.ident = "Lenovo Yoga Pro 7i 9 (83E2)",
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),
	...
	},
	{
		...
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),
			DMI_MATCH(DMI_PRODUCT_FAMILY, "Yoga Pro")
		},
	...
	},
	{
		...
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),
			DMI_MATCH(DMI_PRODUCT_FAMILY, "Yoga Slim 7 Pro")
		},
		.driver_data = (void *)&yoga_dual_8bit_cfg,
	},
	{
		...
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),
			DMI_MATCH(DMI_PRODUCT_FAMILY, "Yoga Slim 7 Carbon")
		},
		.driver_data = (void *)&yoga_slim_cfg,
	},
	{
	...
	},
	{
		...
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),
			DMI_MATCH(DMI_PRODUCT_FAMILY, "Yoga 14s")
		},
		.driver_data = (void *)&yoga_continuous_8bit_cfg,
	},
	{
		.ident = "Lenovo V110 17-inch (80V2)",
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),
	...
	{
		.ident = "Lenovo Yoga 710 (80V4)",
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),
			DMI_MATCH(DMI_PRODUCT_NAME, "80V4")
		},
		.driver_data = (void *)&yoga_710_discrete_cfg,
	},
	{
		.ident = "Lenovo Yoga 710 (80TY)",
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),
			DMI_MATCH(DMI_PRODUCT_NAME, "80TY")
		},
		.driver_data = (void *)&yoga_710_discrete_cfg,
	},
	{
		...
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),
			DMI_MATCH(DMI_PRODUCT_FAMILY, "Yoga 710")
		},
		.driver_data = (void *)&yoga_710_discrete_cfg,
	},
	{
	...
	},
	{
		...
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),
			DMI_MATCH(DMI_PRODUCT_FAMILY, "Yoga 510")
		},
		.driver_data = (void *)&yoga_510_discrete_cfg,
	},
	{
	...
	},
	{
		...
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),
			DMI_MATCH(DMI_PRODUCT_FAMILY, "Yoga 11s")
		},
	...
	},
	{
		...
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),
			DMI_MATCH(DMI_PRODUCT_FAMILY, "Aura Edition")
		},
		.driver_data = (void *)&yoga_continuous_8bit_cfg,
	},
	...
	/* --- 3. LEGION SERIES --- */
	{
		.ident = "Lenovo Legion Pro 7 16IRX9H (83DE)",
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),
	...
	{
		.ident = "Lenovo Legion 7 16IRX9 (83FD)",
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),
	...
	},
	{
		...
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),
			DMI_MATCH(DMI_PRODUCT_FAMILY, "Legion 9")
		},
	...
	},
	{
		...
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),
			DMI_MATCH(DMI_PRODUCT_FAMILY, "Legion P")
		},
		.driver_data = (void *)&legion_high_perf_cfg,
	},
	{
	...
	{
		.ident = "Lenovo LOQ 15ARP9 (83JC)",
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),
			DMI_MATCH(DMI_PRODUCT_NAME, "83JC"),
		},
		/* Use the LOQ-specific profile for gaming chassis inertia */
		.driver_data = (void *)&loq_cfg,
	},
	{
	...
	},
	{
		...
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),
			DMI_MATCH(DMI_PRODUCT_FAMILY, "IdeaPad Y580")
		},
	...
	},
	{
		...
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),
			DMI_MATCH(DMI_PRODUCT_FAMILY, "Lenovo IdeaPad Y580")
		},
		.driver_data = (void *)&ideapad_y580_discrete_cfg,
	},
	{
	...
	},
	{
		...
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),
			DMI_MATCH(DMI_PRODUCT_FAMILY, "Ideapad 500S")
		},
		.driver_data = (void *)&ideapad_500s_discrete_cfg,
	},
	{
	...
	},
	{
		...
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),
			DMI_MATCH(DMI_PRODUCT_FAMILY, "Ideapad 510s")
		},
		.driver_data = (void *)&yoga_510_discrete_cfg,
	},
	{
	...
	},
	{
		...
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),
			DMI_MATCH(DMI_PRODUCT_FAMILY, "Ideapad 710S")
		},
		.driver_data = (void *)&yoga13_continous_cfg,
	},
	{
		...
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),
			DMI_MATCH(DMI_PRODUCT_FAMILY, "IdeaPad Pro 5")
		},
		.driver_data = (void *)&yoga_dual_8bit_cfg,
	},
	...
	/* --- 7. THINKPAD SERIES --- */
	{
		...
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),
			DMI_MATCH(DMI_PRODUCT_FAMILY, "ThinkPad 13")
	...
	},
	{
		...
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),
			DMI_MATCH(DMI_PRODUCT_FAMILY, "ThinkPad L")
		},
	...
	},
	{
		...
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),
			DMI_MATCH(DMI_PRODUCT_FAMILY, "ThinkPad")
		},
		.driver_data = (void *)&thinkpad_discrete_cfg,
	},
	{
	...
	/* --- 8. THINKBOOK SERIES --- */
	{
		.ident = "Lenovo ThinkBook 14 G7+ (21Q4)",
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),
			DMI_MATCH(DMI_PRODUCT_NAME, "21Q4")
		},
		/* Force single profile if WMI is off */
		.driver_data = (void *)&thinkbook_g7_cfg,
	},
	{
		.ident = "Lenovo ThinkBook 14/16 Plus/p",
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),
			DMI_MATCH(DMI_PRODUCT_FAMILY, "ThinkBook 1")
		},
		.driver_data = (void *)&yoga_dual_8bit_cfg,
	},
	...
	/* --- 10. U-SERIES (LEGACY) --- */
	{
		...
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),
			DMI_MATCH(DMI_PRODUCT_FAMILY, "Lenovo u330p")
		},
...
static int yoga_fan_probe(struct platform_device *pdev)
{
	 ...
	 * We iterate through the available paths, enshuring we do not
	 * exceed the array bounds (MAX_FANS) or access uninitialized paths.
	 */
	for (i = 0; i < MAX_FANS; i++) {
		acpi_handle handle;

		/* STOP if we have found all fans defined for this profile */
		if (data->fan_count >= cfg->fan_count)
			break;

		/* STOP if the quirk table has no more paths defined */
		if (!cfg->paths[i])
			break;
		...
		if (ACPI_SUCCESS(status)) {
			...
			/* Log failure for this specific path variation */
			dev_dbg(&pdev->dev, "Fan path %s not found\n", cfg->paths[i]);
		}
	}
